...
- Production rule (PR) :: Two-part structure for antecedent $P$ (that is a conjunctive rule) and consequent $Q$. Conditions in $P$ are evaluated with the current WM in a three-step cycle
